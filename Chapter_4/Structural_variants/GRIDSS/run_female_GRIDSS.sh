...
gridss_latest.sif \
--reference ${ref} \
--output ${vcfoutput}Females_B01.vcf.gz \
--assembly ${bamoutput}Females_B01_gridss.bam \
--threads 8 \
...
/data/alignments_female/bam/sorted/Adelaide.sorted.bam \
/data/alignments_female/bam/sorted/Alice.sorted.bam \
/data/alignments_female/bam/sorted/Aparima.sorted.bam \
/data/alignments_female/bam/sorted/Aranga.sorted.bam \
/data/alignments_female/bam/sorted/Atareta.sorted.bam \
/data/alignments_female/bam/sorted/Aumaria.sorted.bam \
/data/alignments_female/bam/sorted/Awarua.sorted.bam \
/data/alignments_female/bam/sorted/Bella.sorted.bam \
/data/alignments_female/bam/sorted/Boomer.sorted.bam \
/data/alignments_female/bam/sorted/Cyndy.sorted.bam \
/data/alignments_female/bam/sorted/Dusky.sorted.bam
