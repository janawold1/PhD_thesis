...
scriptdir=/data/tara_iti_shortreads/bcftools_SNP_discovery/
bamdir=/data/tara_iti_shortreads/alignments/identity_bam/ #Bam file directory
bcf_dir=/data/tara_iti_shortreads/identity_trial/bcftools/ #bcf file output
...
do
    ...
    bcftools call --threads 32 $file -f GQ -mv -O v -o ${bcf_dir}${base}_VariantCalls.vcf &
done
wait
